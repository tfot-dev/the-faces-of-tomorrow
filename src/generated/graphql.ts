...
export type PostFragment = { __typename?: 'Post' } & Pick<Post, 'id' | 'caption' | 'mediaUrl' | 'timestamp'>;

export type UserFragment = { __typename?: 'users' } & Pick<Users, 'id' | 'name' | 'email_id' | 'admin'>;
...
export function useGetAllEmailsQuery(
    baseOptions?: Apollo.QueryHookOptions<GetAllEmailsQuery, GetAllEmailsQueryVariables>,
) {
...
export function useGetAllEmailsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GetAllEmailsQuery, GetAllEmailsQueryVariables>,
) {
